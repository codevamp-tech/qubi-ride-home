        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-white/40 max-w-xs leading-relaxed text-lg">
                Premium online taxi booking for the modern traveler. Ride with confidence, ride with Qubi.
              </p>
            </div>

            <div>
              <h4 className="font-bold mb-6 uppercase text-xs tracking-widest text-[#ffd700]">Quick Links</h4>
              <ul className="space-y-4 text-white/50 text-sm">
                <li><a href="#about" className="hover:text-white transition-colors">About Us</a></li>
                <li><a href="#features" className="hover:text-white transition-colors">Features</a></li>
                <li><a href="#airport-ride" className="hover:text-white transition-colors">Airport Ride</a></li>
            ...
            <div>
              <h4 className="font-bold mb-6 uppercase text-xs tracking-widest text-[#ffd700]">Legal</h4>
              <ul className="space-y-4 text-white/50 text-sm">
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col md:row items-center justify-between gap-4">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-white/30 hover:text-white transition-colors">Twitter</a>
              <a href="#" className="text-white/30 hover:text-white transition-colors">Instagram</a>
              <a href="#" className="text-white/30 hover:text-white transition-colors">LinkedIn</a>
            </div>
          </div>
        </div>
      </footer>
